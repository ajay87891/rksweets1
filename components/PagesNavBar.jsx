          ...
          (item) => {
            return (
              <li className="cursor-pointer flex flex-col group items-center" key={`link-${item}`}>
                ...
                <Link className="text-white font-medium 2xl:text-2xl font-Quicksand group-hover:text-violet-200 ease-in-out duration-500 transition-all uppercase" href={`\\${item}`}>{item}</Link>
